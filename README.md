...
2. פתיחה בדפדפן:
   - Reader (דפדוף): http://127.0.0.1:5500/preview
   - פתיחה על קובץ מסוים: http://127.0.0.1:5500/preview?file=%D7%A2%D7%9E%D7%95%D7%93-3.html

> הערה: במצב `-Lan` הסקריפט ידפיס קישור כמו `http://<IP>:5500/preview`.
> אם ה־Windows Firewall חוסם, צריך לאפשר כניסות ל־פורט 5500.
